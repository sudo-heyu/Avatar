...
private:
    ...
    */
    ...
    // 口型参数强制覆盖值：确保口型参数具有最高优先级，覆盖 Motion 的值
    Csm::csmFloat32 _overrideMouthOpenY; ///< 强制覆盖的 ParamMouthOpenY 值
    Csm::csmFloat32 _overrideMouthForm; ///< 强制覆盖的 ParamMouthForm 值
    Csm::csmBool _mouthOverrideActive; ///< 是否激活口型覆盖
