...
namespace {
    ...
    const csmChar* ColorBlendShaderPath = "shaders/StandardES/FragShaderSrcColorBlend.frag";
    const csmChar* AlphaBlendShaderPath = "shaders/StandardES/FragShaderSrcAlphaBlend.frag";
#else
...
{
#ifdef CSM_TARGET_ANDROID_ES2
    Csm::csmString vertPath("shaders/StandardES/");
    vertPath += vertShaderPath;
    Csm::csmString fragPath("shaders/StandardES/");
    fragPath += fragShaderPath;
    vertShaderPath = vertPath.GetRawString();
    fragShaderPath = fragPath.GetRawString();
#endif
